    ...
    return (
        <div className="w-full bg-[#101010] flex flex-col justify-center md:justify-between md:px-[120px] px-[50px] py-[30px] items-center">
            ...
            <div className='flex border-t-[1px] border-t-[white]'>
                ...
                <SocialMedia link='https://twitter.com/metaxseed' iconName='twitter'/>
                <SocialMedia link='https://t.me/metaxseed' iconName='telegram'/>
                <SocialMedia link='https://t.me/metaxseed_ann' iconName='telegram'/>
                <SocialMedia link='contact@metaxseed.io' iconName='mail'/>
                <SocialMedia link='https://discord.gg/metaxseed' iconName='discord'/>
            </div>
